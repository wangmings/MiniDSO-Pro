...
int16 TriLevel_m;                                            //用户设定触发值，mV / Trigger Level in mV
uint8 TriPos;                                              //触发位置 / Trigger Position
int8 TriPosOffset;                                         //触发位置偏移量 / Trigger Position Offset
int32 RulerVMin, RulerVMax;                                //纵轴电压最大最小值 / Min and Max voltage on vertical ruler
int32 RulerVMin_m, RulerVMax_m;                                //纵轴电压最大最小值 / Min and Max voltage on vertical ruler
int32 VMax, VMin;                                         //屏幕波形的最大和最小电压mV，上限65535mV
...
**/
Option_InMain_MeaWay_t Option_InMain_MeaWay;
...
int8 OptionInChart;                                        //主界面的选项序号, 0:ScaleH, 1:ScaleV, 2:TriLevel, 3:TriSlope, 4:TriMode 5 MeaWay
